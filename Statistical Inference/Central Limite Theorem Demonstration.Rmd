...
Although this sample size is too small, lets take a look on the variance parameter (by estimating it using a unbiased sample variance)

```{r}
unbiased_var = sum((x - mean(x))^2) / length(x) - 1
sample_sd = sqrt(unbiased_var)
```
